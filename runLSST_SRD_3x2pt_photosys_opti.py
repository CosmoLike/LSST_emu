...
data_file = os.path.join(dirname, "datav/LSST_3x2pt_fid_opti")
cov_file = os.path.join(dirname, "cov/LSST_SRD_cov_3x2pt_inv")
chain_file = os.path.join(dirname, "like/like_LSST_ocelote_3x2pt_SN10_photosys_opti")

initcosmo("halofit")
initbins(20,20.0,15000.0,3000.0,21.0,10,10)
initpriors("opti","none","none","none") 
initsurvey("LSST")
...
sample_main(sample_params,1500,560,1,chain_file, blind=False, pool=MPIPool())
