...
int main(int argc, char** argv)
{
  ...
  k=1;
  int N_scenarios=1;
  double scenario_table[1][3]={{14202.63,27.0,48.0}};
  ...
  for(t=0;t<1;t++){ 
    ...
    init_survey("LSST");
    sprintf(arg1,"zdistris/SRD_zdistri_model_z0=1.100000e-01_beta=6.800000e-01_Y10_source.txt");
    sprintf(arg2,"zdistris/SRD_zdistri_model_z0=2.800000e-01_beta=9.000000e-01_Y10_lens.txt"); 
    ...
    sprintf(survey.name,"LSST_DESC_SRD_area%le_ng%le_nl%le",survey.area,survey.n_gal,survey.n_lens);
