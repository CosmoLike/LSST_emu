...
### ------------------------------------------------
zpivot=0.4
samples=loadMCSamples('./LSST_3x2pt_sys_model_11',settings=analysissettings0)
p = samples.getParams()
...
samples=loadMCSamples('./LSST_3x2pt_sys_model_12',settings=analysissettings0)
p = samples.getParams()
samples.addDerived(1e9*p.sigma8,name='AA',label='10^9 A_\mathrm{s}',
  range=[samples.getLower('sigma8')*1e9,samples.getUpper('sigma8')*1e9])
samples.addDerived(100*p.h0,name='H0',label='H_0',
...
samples=loadMCSamples('./LSST_3x2pt_sys_model_13',settings=analysissettings0)
p = samples.getParams()
samples.addDerived(1e9*p.sigma8,name='AA',label='10^9 A_\mathrm{s}',
  range=[samples.getLower('sigma8')*1e9,samples.getUpper('sigma8')*1e9])
samples.addDerived(100*p.h0,name='H0',label='H_0',
